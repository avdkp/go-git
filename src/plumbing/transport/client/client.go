...
import (
	...
	"github.com/avdkp/go-git/src/plumbing/transport/file"
	"github.com/avdkp/go-git/src/plumbing/transport/git"
	"github.com/avdkp/go-git/src/plumbing/transport/http"
	"github.com/avdkp/go-git/src/plumbing/transport/ssh"
)
