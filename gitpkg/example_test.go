...
func ExampleClone() {
	...
	_, err := gitpkg.Clone(storer, fs, &gitpkg.CloneOptions{
...
func ExamplePlainClone() {
	...
	_, err = gitpkg.PlainClone(dir, false, &gitpkg.CloneOptions{
		URL: "https://github.com/git-fixtures/basic.git",
	})
...
func ExampleRepository_References() {
	r, _ := gitpkg.Clone(memory.NewStorage(), nil, &gitpkg.CloneOptions{
		URL: "https://github.com/git-fixtures/basic.git",
	})
...
func ExampleRepository_CreateRemote() {
	r, _ := gitpkg.Init(memory.NewStorage(), nil)
